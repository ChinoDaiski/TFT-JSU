...
HRESULT CMapObject::NativeConstruct(void * pArg)
{
	...
	m_pTransformCom->Set_State(CTransform::STATE_POSITION, XMLoadFloat4((XMFLOAT4*)MapObjDesc.TransformMatrix.m[3]));
...
HRESULT CMapObject::SetUp_Components(void* pArg)
{
	...
	/* For.Com_Model */
	if (FAILED(__super::SetUp_Components(TEXT("Com_Model"), LEVEL_GAMEPLAY, MapObjDesc.pPrototype_ObjectName, (CComponent**)&m_pModelCom)))
		return E_FAIL;
