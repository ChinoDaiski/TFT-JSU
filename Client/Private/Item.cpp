...
CItem::CItem(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
...
CItem * CItem::Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
{
	CItem*	pInstance = new CItem(pDeviceOut, pDeviceContextOut);
