...
CSkill::CSkill(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
...
HRESULT CSkill::NativeConstruct_Prototype()
{
...
HRESULT CSkill::NativeConstruct(void * pArg)
{
...
void CSkill::Tick(_double TimeDelta)
{
...
void CSkill::LateTick(_double TimeDelta)
{
...
CSkill * CSkill::Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
{
	CSkill*	pInstance = new CSkill(pDeviceOut, pDeviceContextOut);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created CSkill"));
