...
void CCamera::Set_Aspect(const RECT& rtWindowResolution)
{
	m_CameraDesc.fAspect = 1.f * (rtWindowResolution.right - rtWindowResolution.left) / (rtWindowResolution.bottom - rtWindowResolution.top);
}
